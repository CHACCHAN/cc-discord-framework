...
cc-discord-framework(`@cc-discord-framework/core` と公式プラグイン)の **公開 API リファレンス** です。
...
`@cc-discord-framework/core` は `export * from "discord.js"` により **discord.js の全 API をそのまま再エクスポート** しています。Bot 側は `@cc-discord-framework/core` だけを import すれば、`GatewayIntentBits` / `Events` / `EmbedBuilder` などの discord.js の API もすべて利用できます。
...
| パッケージ | 内容 |
| --- | --- |
| `@cc-discord-framework/core` | フレームワーク本体(クライアント・コンポーネントモデル・コマンド・リスナー・Precondition・サービス・プラグイン機構) |
...
- [@cc-discord-framework/ai](@cc-discord-framework/ai/index.md)
- [@cc-discord-framework/core](@cc-discord-framework/core/index.md)
- [@cc-discord-framework/music](@cc-discord-framework/music/index.md)
- [@cc-discord-framework/music-sources](@cc-discord-framework/music-sources/index.md)
- [@cc-discord-framework/utils](@cc-discord-framework/utils/index.md)
