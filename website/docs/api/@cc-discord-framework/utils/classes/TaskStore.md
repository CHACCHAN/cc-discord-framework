...
定義: plugins/utils/src/scheduler.ts:69

[Task](Task.md) コンポーネントのストア。`tasks/` を走査し、稼働中はスケジュールを管理します。

## 拡張

- [`ComponentStore`](../../../cc-discord-framework/classes/ComponentStore.md)\<[`Task`](Task.md)\>
...
定義: plugins/utils/src/scheduler.ts:74
...
定義: plugins/utils/src/scheduler.ts:78
...
定義: plugins/utils/src/scheduler.ts:106
...
[`ComponentClass`](../../../cc-discord-framework/type-aliases/ComponentClass.md)\<[`Task`](Task.md)\>
...
定義: plugins/utils/src/scheduler.ts:112
